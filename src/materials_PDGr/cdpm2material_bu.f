...
c
      ...
      PROGRAM main
      double precision :: strainInc(6), oldStrain(6), stressOld(6),
     $    stressNew(6)
      double precision :: enerInternOld, enerInelasOld
      double precision :: enerInternNew, enerInelasNew
      double precision :: stateOld(49), stateNew(49)
      call cdpm2inputparams(1,30000,0.2,30,3,0.1,0.08, 0.003,2., 1e-06,
     $    0.001, 15.0, 10)
      strainInc = (/0.001,0.001,0.001,0.001,0.001,0.001/)
      oldStrain = 0.0
      stressOld = 0.0
      stressNew = 0.0
      enerInternOld = 0.0
      ...
      stateOld = 0.0
      stateNew = 0.0
      call cdpm2material(1e-7, strainInc, oldStrain,
     $     stressOld, stateOld, enerInternOld, enerInelasOld,
     $     stressNew, stateNew, enerInternNew, enerInelasNew )
      write(*,*) stressNew
      END PROGRAM main
